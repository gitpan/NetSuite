...
my $debug = 1;
#my $wsdl = 'https://webservices.netsuite.com/wsdl/v2008_1_0/netsuite.wsdl';
#my $searchCommon = 'https://webservices.netsuite.com/xsd/platform/v2008_1_0/common.xsd';
my $wsdl = 'https://webservices.netsuite.com/wsdl/v2_6_0/netsuite.wsdl';
my $searchCommon = 'https://webservices.netsuite.com/xsd/platform/v2_6_0/common.xsd';
